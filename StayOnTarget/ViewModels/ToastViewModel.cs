...
public class ToastViewModel : ViewModelBase
{
    ...
    public ToastViewModel(string message, Action<ToastViewModel> onClose, ToastType? type = null)
    {
        try
        {
            ...
            CloseCommand = new RelayCommand(() => 
            {
                ...
                {
                    Log.Error(ex, "Error executing CloseCommand for ToastViewModel.");
            ...
            _autoCloseTimer.Tick += (s, e) =>
            {
                ...
                {
                    Log.Error(ex, "Error during ToastViewModel auto-close timer tick.");
        ...
        {
            Log.Fatal(ex, "Critical error initializing ToastViewModel.");
    ...
    private void SetProperties(ToastType toastType) {
        ...
        {
            Log.Error(ex, "Error setting properties for ToastType {ToastType}.", toastType);
